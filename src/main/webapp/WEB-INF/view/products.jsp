...
<table border="1" align="center" width="450">
  ...
  <tr>
    <td>
      <form action="productcontroller.form">
        <%if (request.getAttribute("notDelete") != null) {%>
        <h2 align="center">
...
<%}%>
<h3 align="center"><a href="/sellercontroller.form">To seller's database</a><a>             </a><a href="combinecontroller.form">To calculation of salaries</a></h3>
<table border="1" align="center" width="450">
  <tbody>
  <tr>
    <td>
